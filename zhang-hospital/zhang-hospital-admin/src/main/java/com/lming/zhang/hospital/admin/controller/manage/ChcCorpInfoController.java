...
public class ChcCorpInfoController {
    ...
    private static final Logger LOGGER = LoggerFactory.getLogger(ChcCorpInfoController.class);
    ...
    public Object list(
        ...
        List<ChcCorpInfo> rows = chcCorpInfoService.selectByExampleForStartPage(example, pageNum, pageSize);

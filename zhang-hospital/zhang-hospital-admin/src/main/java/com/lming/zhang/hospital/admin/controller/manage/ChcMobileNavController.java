...
public class ChcMobileNavController {
    ...
    private static final Logger LOGGER = LoggerFactory.getLogger(ChcMobileNavController.class);
    ...
    public Object list(
        ...
        List<ChcMobileNav> rows = chcMobileNavService.selectByExampleForStartPage(example, pageNum, pageSize);

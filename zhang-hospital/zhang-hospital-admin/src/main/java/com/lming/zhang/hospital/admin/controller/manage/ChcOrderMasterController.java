...
public class ChcOrderMasterController {
    ...
    private static final Logger LOGGER = LoggerFactory.getLogger(ChcOrderMasterController.class);
    ...
    public Object list(
        ...
        List<ChcOrderMaster> rows = chcOrderMasterService.selectByExampleForStartPage(example, pageNum, pageSize);

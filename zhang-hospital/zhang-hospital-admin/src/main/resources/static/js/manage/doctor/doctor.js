// 基础数据维护
var dgId = "#dgBox";
var queryUrl = BASE_PATH + "/manage/doctor/list";
...
function getColumnsOpt()
{
	var opt = 
		[[
		  	{field:'doctorId',title:'医师编号',width:10,align:'left',sortable:true},
            {field:'doctorName',title:'医师名称',width:10,align:'left',sortable:true},
            {field:'sex',title:'性别',width:10,align:'left',sortable:true},
            {field:'idCardNo',title:'身份证号',width:10,align:'left',sortable:true}
